...
export default function GuardianOnboarding3() {
  ...
  return (
    ...
    >
      <View className="w-full">
        ...
        <View className="mt-16">
          <Text
            ...
            className="text-font text-center font-semibold text-[20px]"
          >
            Notaries as Guardians
          </Text>
      ...
      <View>
        ...
        <CustomButton label="NEXT" target="Guardian" />
      </View>
    </SafeAreaView>
  );
}
